...
class FileInitTests {
	...
	public void testRoomLabels() {
		...
		assertEquals("Server Room", board.getRoom('S').getName() );
		assertEquals("Break Room", board.getRoom('B').getName() );
		assertEquals("Cubicle", board.getRoom('U').getName() );
		assertEquals("Reception", board.getRoom('R').getName() );
		assertEquals("Jim Gym", board.getRoom('G').getName() );
	}
	...
	public void FourDoorDirections() {
		BoardCell cell = board.getCell(1, 7);
	...
	public void testRooms() {
		...
		room = board.getRoom( cell ) ;
		assertTrue( room != null );
		assertEquals( room.getName(), "Reception" ) ;
		...
		room = board.getRoom( cell ) ;
		assertTrue( room != null );
		assertEquals( room.getName(), "Regional Manager's Office" ) ;
